...
typedef struct jogada {
       ...
       struct jogada* prox; // ponteiro para o próximo registro
} JOGADAS; 
 ...
 * entrada : JOGADORES                          *
 * saída   : NULL (inicializa JOGADORES)        *
 ************************************************/ 
void jogar( JOGADORES** j)
{
	...
	while (t < 4) {
	    ...
	    int ultimaCor = 0; // armazena o código da cor randômica
 ...
 * objetivo: ordenar ranking por pontuação         *
 * entrada : lista                                 *
 * saida   : lista ordenada por pontuação          *
 *************************************************** 
